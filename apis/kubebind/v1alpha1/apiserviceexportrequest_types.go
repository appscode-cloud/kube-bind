...
const (
	ResourceKindAPIServiceExportRequest = "APIServiceExportRequest"
	ResourceAPIServiceExportRequest     = "apiserviceexportrequest"
	ResourceAPIServiceExportRequests    = "apiserviceexportrequests"
)
