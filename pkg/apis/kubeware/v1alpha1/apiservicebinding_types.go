...
const (
	...
	DownstreamFinalizer = "kubeware.dev/syncer"
)
...
// +kubebuilder:resource:scope=Cluster,categories=kubewares,shortName=sb
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="Provider",type="string",JSONPath=`.status.providerPrettyName`,priority=0
// +kubebuilder:printcolumn:name="Resources",type="string",JSONPath=`.metadata.annotations.kubeware\.dev/resources`,priority=1
