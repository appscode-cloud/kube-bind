...
func ServiceExportToCRD(export *kubewarev1alpha1.APIServiceExport) (*apiextensionsv1.CustomResourceDefinition, error) {
...
func CRDToServiceExport(crd *apiextensionsv1.CustomResourceDefinition) (*kubewarev1alpha1.APIServiceExportCRDSpec, error) {
	spec := &kubewarev1alpha1.APIServiceExportCRDSpec{
	...
	for i := range crd.Spec.Versions {
		...
		apiResourceVersion := kubewarev1alpha1.APIServiceExportVersion{
...
func APIServiceExportCRDSpecHash(obj *kubewarev1alpha1.APIServiceExportCRDSpec) string {
