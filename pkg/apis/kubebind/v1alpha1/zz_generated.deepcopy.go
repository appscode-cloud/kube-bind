...
func (in *APIServiceExportSpec) DeepCopyInto(out *APIServiceExportSpec) {
	*out = *in
	...
	if in.PermissionClaims != nil {
		...
		*out = make([]PermissionClaimTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *APIServiceExportTemplateList) DeepCopyInto(out *APIServiceExportTemplateList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]APIServiceExportTemplateList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClaimResourceVerbTemplate) DeepCopyInto(out *ClaimResourceVerbTemplate) {
	*out = *in
	if in.Provider != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClaimResourceVerbTemplate.
func (in *ClaimResourceVerbTemplate) DeepCopy() *ClaimResourceVerbTemplate {
	if in == nil {
		return nil
	}
	out := new(ClaimResourceVerbTemplate)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PermissionClaimTemplate) DeepCopyInto(out *PermissionClaimTemplate) {
	*out = *in
	in.ResourceConnection.DeepCopyInto(&out.ResourceConnection)
	in.Verbs.DeepCopyInto(&out.Verbs)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PermissionClaimTemplate.
func (in *PermissionClaimTemplate) DeepCopy() *PermissionClaimTemplate {
	if in == nil {
		return nil
	}
	out := new(PermissionClaimTemplate)
	in.DeepCopyInto(out)
	return out
}
