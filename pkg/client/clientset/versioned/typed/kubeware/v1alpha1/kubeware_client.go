...
import (
	...
	v1alpha1 "go.kubeware.dev/kubeware/pkg/apis/kubeware/v1alpha1"
	"go.kubeware.dev/kubeware/pkg/client/clientset/versioned/scheme"
...
// KubeBindV1alpha1Client is used to interact with features provided by the kubeware.dev group.
